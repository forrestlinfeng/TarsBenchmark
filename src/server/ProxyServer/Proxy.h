...
namespace bm
{
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["para_output"] = tars::JsonOutput::writeJson(para_output);
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(para_output,pObj->value["para_output"], false);
        ...
        ostream& display(ostream& _os, int _level=0) const
        {
            ...
            _ds.display(para_output,"para_output");
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            pair<string*, string*> r = equal_range(__Proxy_all, __Proxy_all+4, string(msg->request.sFuncName));
    ...
    public:
        ...
        void async_query(ProxyPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void coro_query(ProxyCoroPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void async_shutdown(ProxyPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void coro_shutdown(ProxyCoroPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void async_startup(ProxyPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void coro_startup(ProxyCoroPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void async_test(ProxyPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
        ...
        void coro_test(ProxyCoroPrxCallbackPtr callback,const bm::BenchmarkUnit &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
    ...
    public:
        ...
        {
            static ::std::string __bm__Proxy_all[]=
            {
                "query",
                "shutdown",
                "startup",
            ...
            pair<string*, string*> r = equal_range(__bm__Proxy_all, __bm__Proxy_all+4, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __bm__Proxy_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
