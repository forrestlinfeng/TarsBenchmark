...
namespace bm
{
    enum BMErrCode
    {
        ...
        BM_EXCEPTION = -1,
        BM_ERR_PARAM = -2,
        BM_PROXY_ERR_NOTFIND = -10001,
        BM_PROXY_ERR_RUNNING = -10002,
        BM_PROXY_ERR_STARTUP = -10003,
        BM_PROXY_ERR_SHUTDOWN = -10004,
    ...
    inline string etos(const BMErrCode & e)
    {
        switch(e)
        {
            case BM_SUCC: return "BM_SUCC";
            case BM_EXCEPTION: return "BM_EXCEPTION";
            case BM_ERR_PARAM: return "BM_ERR_PARAM";
            case BM_PROXY_ERR_NOTFIND: return "BM_PROXY_ERR_NOTFIND";
            case BM_PROXY_ERR_RUNNING: return "BM_PROXY_ERR_RUNNING";
            case BM_PROXY_ERR_STARTUP: return "BM_PROXY_ERR_STARTUP";
            case BM_PROXY_ERR_SHUTDOWN: return "BM_PROXY_ERR_SHUTDOWN";
    ...
    {
        if(s == "BM_SUCC")  { e=BM_SUCC; return 0;}
        if(s == "BM_EXCEPTION")  { e=BM_EXCEPTION; return 0;}
        if(s == "BM_ERR_PARAM")  { e=BM_ERR_PARAM; return 0;}
        if(s == "BM_PROXY_ERR_NOTFIND")  { e=BM_PROXY_ERR_NOTFIND; return 0;}
        if(s == "BM_PROXY_ERR_RUNNING")  { e=BM_PROXY_ERR_RUNNING; return 0;}
        if(s == "BM_PROXY_ERR_STARTUP")  { e=BM_PROXY_ERR_STARTUP; return 0;}
        if(s == "BM_PROXY_ERR_SHUTDOWN")  { e=BM_PROXY_ERR_SHUTDOWN; return 0;}
    ...
    public:
        ...
        static string MD5()
        {
            return "561b555837d08d82badb24f1fb7ff3c8";
        }
        ResultStat()
        {
            resetDefautlt();
    ...
    public:
        ...
        map<tars::Int32, tars::Int32> ret_map;
        map<tars::Int32, tars::Int32> cost_map;
    ...
    public:
        ...
        {
            resetDefautlt();
            _is.read(servant, 0, false);
            _is.read(rpcfunc, 1, false);
    ...
    {
        return l.servant == r.servant && l.rpcfunc == r.rpcfunc && l.threads == r.threads && l.links == r.links && l.speed == r.speed;
    }
    inline bool operator!=(const ExecItem&l, const ExecItem&r)
    {
        return !(l == r);
    ...
    public:
        ...
        static string MD5()
        {
            return "d5d99e50e68492d8ce57e59af97ac5ac";
        }
        TaskConf()
        {
            resetDefautlt();
        ...
        void writeTo(tars::TarsOutputStream<WriterT>& _os) const
        {
            ...
            if (paravals.size() > 0)
            {
                _os.write(paravals, 3);
            }
            if (endpoints.size() > 0)
            {
                _os.write(endpoints, 4);
            }
            if (links != 0)
            {
                _os.write(links, 5);
        ...
        void readFrom(tars::TarsInputStream<ReaderT>& _is)
        {
            ...
            _is.read(paravals, 3, false);
            _is.read(endpoints, 4, false);
            _is.read(links, 5, false);
            _is.read(speed, 6, false);
            _is.read(runflag, 7, false);
        }
        tars::JsonValueObjPtr writeToJson() const
        {
            tars::JsonValueObjPtr p = new tars::JsonValueObj();
            ...
            p->value["paravals"] = tars::JsonOutput::writeJson(paravals);
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(paravals,pObj->value["paravals"], false);
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(paravals, true);
    ...
    {
        return l.servant == r.servant && l.rpcfunc == r.rpcfunc && l.paralist == r.paralist && l.paravals == r.paravals && l.endpoints == r.endpoints && l.links == r.links && l.speed == r.speed && l.runflag == r.runflag;
    }
    inline bool operator!=(const TaskConf&l, const TaskConf&r)
    {
        return !(l == r);
